...
Original file is located at
    https://colab.research.google.com/drive/1ZCdPrtNZMkWIZ1vEQxf4emMznM-GSZq0
...
idx = 2
img0 = imread(PATH + 'train_images/' + train['ImageId'][idx] + '.jpg')
img = preprocess_image(img0)

mask, regr = get_mask_and_regr(img0, train['PredictionString'][idx])
...
#train_dataset_flip = CarDataset_flip(df_train, train_images_dir, training=True)
...
# img, mask, regr = train_dataset_flip[2]
...
#train_loader_flip = DataLoader(dataset=train_dataset, batch_size=BATCH_SIZE, shuffle=True, num_workers=4)
...
if lr_warmup_until > 0 and iteration <= lr_warmup_until:
    set_lr(optimizer, (lr - lr_warmup_init) * (iteration / lr_warmup_until) + lr_warmup_init)
"""
...
def train_model(epoch, history=None):
    ...
    #for (batch_idx, (img_batch, mask_batch, regr_batch)), (batch_idx2, (img_batch2, mask_batch2, regr_batch2)) \
    #in tqdm(zip(enumerate(train_loader), enumerate(train_loader_flip))):
        ...
        #mask_batch2 = mask_batch2.to(device)
        #regr_batch2 = regr_batch2.to(device)
        
        optimizer.zero_grad()
        #output = model(img_batch)
        output = model(img_batch)
        #output2 = model(img_batch)
        loss = criterion(output, mask_batch, regr_batch) 
        #loss2 = criterion(output2, mask_batch2, regr_batch2)
        #loss = (loss+loss2)/2
...
"""100%|██████████| 1055/1055 [11:35<00:00,  1.52it/s]
Train Epoch: 0 	LR: 0.001000	Loss: 56.546242
Dev loss: 44.4305
100%|██████████| 1055/1055 [11:36<00:00,  1.52it/s]
Train Epoch: 1 	LR: 0.001000	Loss: 42.693676
  0%|          | 0/1055 [00:00<?, ?it/s]
Dev loss: 40.6591
100%|██████████| 1055/1055 [11:36<00:00,  1.51it/s]
Train Epoch: 2 	LR: 0.001000	Loss: 50.856449
Dev loss: 35.9898
100%|██████████| 1055/1055 [11:36<00:00,  1.51it/s]
Train Epoch: 3 	LR: 0.000100	Loss: 30.937057
  0%|          | 0/1055 [00:00<?, ?it/s]
Dev loss: 33.8869
100%|██████████| 1055/1055 [11:36<00:00,  1.51it/s]
Train Epoch: 4 	LR: 0.000100	Loss: 21.396093
  0%|          | 0/1055 [00:00<?, ?it/s]
Dev loss: 33.6518
100%|██████████| 1055/1055 [11:44<00:00,  1.50it/s]
Train Epoch: 5 	LR: 0.000010	Loss: 31.228779
Dev loss: 32.9903
"""
